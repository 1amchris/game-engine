...
public class NMEntityRenderer {
	...
	private final NMEntityShader shader;

	public NMEntityRenderer(NMEntityShader shader) {
		this.shader = shader;
	}
	...
	public void start(List<LightSource> lights, Camera camera, Vector4f clipPlane, Vector3f skyColour) {
		shader.start();
